...
HD_PWD='C:/git/EEL4740/project/project.runs/system_PmodOLED_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_PmodOLED_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_PmodOLED_0_1.tcl
